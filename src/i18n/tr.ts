export const tr = {
  ...
  daysLeft: "gün",
  freeLastChance: "Son şans",
  freeEndingSoonTitle: "Son şans — yakında bitiyor",
  freeEndingSoonNote: "Bu ücretsiz oyunlar 48 saat içinde kapanıyor. Kaçırma.",
  freeClaim: "Hemen al",
  ...
  ownAdd: "Sahibim",
  ownOwned: "Sahibim ✓",
  ownHint: "Bu oyun sende varsa işaretle — koleksiyonuna eklenir, fiyatı düşünce görürsün.",
  collectionPage: "Koleksiyonum",
  collectionNote: "Sahip olduğun oyunlar. İndirime girenleri burada öne çıkarırız.",
  collectionEmpty: "Henüz oyun işaretlemedin. Kartlardaki 'Sahibim' ile koleksiyonunu oluştur.",
  collectionOnSale: "Şu an indirimde",
  collectionCount: "oyun",
  ownImportTitle: "Steam kütüphaneni içe aktar",
  ownImportHint: "SteamID veya profil linkini yapıştır. (Steam profilinde 'oyun detayları' herkese açık olmalı.)",
  ownImportPlaceholder: "SteamID64 veya steamcommunity.com/id/…",
  ownImportBtn: "İçe aktar",
  ownImportLoading: "Yükleniyor…",
  ownImportPrivate: "Profil gizli ya da boş. Steam → Profil → Gizlilik → 'Oyun detayları' = Herkese açık yap.",
  ownImportNotFound: "Steam profili bulunamadı. Linki/ID'yi kontrol et.",
  ownImportNoKey: "Steam içe aktarma şu an kullanılamıyor.",
  ownImportError: "Bir hata oldu, tekrar dene.",
  genresPage: "Türler",
  genresNote: "Türe göz at — her tür tüm mağazalarda TL fiyatıyla karşılaştırılır.",
  aboutGame: "Hakkında",
