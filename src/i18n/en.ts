...
export const en: Record<keyof typeof tr, string> = {
  ...
  daysLeft: "days",
  freeLastChance: "Last chance",
  freeEndingSoonTitle: "Last chance — ending soon",
  freeEndingSoonNote: "These freebies close within 48 hours. Don't miss out.",
  freeClaim: "Claim now",
  ...
  saleEndsIn: "ends in",
  saleDayUnit: "days",
  seasonStarted: "is live",
  seasonCta: "See deals",
  seasonSummer: "Summer Sale",
  seasonAutumn: "Autumn Sale",
  seasonWinter: "Winter Sale",
  seasonSpring: "Spring Sale",
  heatVote: "Heat",
  heatVoted: "Heat ✓",
  heatHint: "Good deal? Give it 🔥 — you shape the community ranking.",
  hotDealsPage: "Hot Deals",
  hotDealsNote: "The hottest deals, surfaced by the community with 🔥.",
  hotDealsEmpty: "No votes yet. Be the first 🔥 — open a game page and vote on its deal.",
  hotDealsHeat: "heat",
  ownAdd: "I own it",
  ownOwned: "Owned ✓",
  ownHint: "Mark games you own — they go to your collection and you'll see when prices drop.",
  collectionPage: "My Collection",
  collectionNote: "Games you own. We surface the ones that go on sale here.",
  collectionEmpty: "No games marked yet. Use 'I own it' on cards to build your collection.",
  collectionOnSale: "On sale now",
  collectionCount: "games",
  ownImportTitle: "Import your Steam library",
  ownImportHint: "Paste a SteamID or profile link. (Your Steam 'game details' must be public.)",
  ownImportPlaceholder: "SteamID64 or steamcommunity.com/id/…",
  ownImportBtn: "Import",
  ownImportLoading: "Loading…",
  ownImportPrivate: "Profile private or empty. Steam → Profile → Privacy → set 'Game details' to Public.",
  ownImportNotFound: "Steam profile not found. Check the link/ID.",
  ownImportNoKey: "Steam import is currently unavailable.",
  ownImportError: "Something went wrong, try again.",
  genresPage: "Genres",
  genresNote: "Browse by genre — every genre compared across all stores in TRY.",
  aboutGame: "About",
